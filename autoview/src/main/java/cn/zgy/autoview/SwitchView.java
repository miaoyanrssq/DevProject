 ...
 *  color_theme：选中状态背景色
    color_bg：未选中背景色
    color_tab：tab颜色
    boolean isOpen; 初始状态是否选中
    shape;形状
* @author zhengy
* create at 2018/9/21 下午2:50
**/
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_theme = a.getColor(R.styleable.switchview_themeColor,
                DEFAULT_COLOR_THEME);
        color_bg = a.getColor(R.styleable.switchview_bgColor,
                Color.GRAY);
        color_tab = a.getColor(R.styleable.switchview_tabColor,
                Color.WHITE);
        isOpen = a.getBoolean(R.styleable.switchview_isOpen, false);
        shape = a.getInt(R.styleable.switchview_shape, SHAPE_RECT);
        a.recycle();
    }
