...
public class GestureCover extends BaseCover implements OnTouchGestureListener {
    ...
    @BindView(R2.id.cover_player_gesture_operation_volume_box)
    View mVolumeBox;
    @BindView(R2.id.cover_player_gesture_operation_brightness_box)
    View mBrightnessBox;
    @BindView(R2.id.cover_player_gesture_operation_volume_icon)
    ImageView mVolumeIcon;
    @BindView(R2.id.cover_player_gesture_operation_volume_text)
    TextView mVolumeText;
    @BindView(R2.id.cover_player_gesture_operation_brightness_text)
    TextView mBrightnessText;
    @BindView(R2.id.cover_player_gesture_operation_fast_forward_box)
    View mFastForwardBox;
    @BindView(R2.id.cover_player_gesture_operation_fast_forward_text_view_step_time)
    TextView mFastForwardStepTime;
    @BindView(R2.id.cover_player_gesture_operation_fast_forward_text_view_progress_time)
