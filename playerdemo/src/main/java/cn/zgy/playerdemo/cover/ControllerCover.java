package cn.zgy.playerdemo.cover;
...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener {
    ...
    @BindView(R2.id.cover_player_controller_top_container)
    View mTopContainer;
    @BindView(R2.id.cover_player_controller_bottom_container)
    View mBottomContainer;
    @BindView(R2.id.cover_player_controller_image_view_back_icon)
    ImageView mBackIcon;
    @BindView(R2.id.cover_player_controller_text_view_video_title)
    TextView mTopTitle;
    @BindView(R2.id.cover_player_controller_image_view_play_state)
    ImageView mStateIcon;
    @BindView(R2.id.cover_player_controller_text_view_curr_time)
    TextView mCurrTime;
    @BindView(R2.id.cover_player_controller_text_view_total_time)
    TextView mTotalTime;
    @BindView(R2.id.cover_player_controller_image_view_switch_screen)
    ImageView mSwitchScreen;
    @BindView(R2.id.cover_player_controller_seek_bar)
    SeekBar mSeekBar;
    ...
    @OnClick({
            R2.id.cover_player_controller_image_view_back_icon,
            R2.id.cover_player_controller_image_view_play_state,
            R2.id.cover_player_controller_image_view_switch_screen})
