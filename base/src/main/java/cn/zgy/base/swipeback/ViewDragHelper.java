...
public class ViewDragHelper {
     ...
     * callback's
     * {@link // toolbar.toolbar.base.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link // toolbar.toolbar.base.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link // toolbar.toolbar.base.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
